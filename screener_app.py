...
COMBOS = [
    ...
    # FINAL (Union AB, 1h par 400-coin confirm): Ichimoku+MS + EMA+Breakout
    # ka union PF 10.22 - MarketStructure+CVD nikal di gayi (union mein
    # shamil karne se PF kam hota hai: 10.22 -> 10.14 ABC, 9.12 ABD)
