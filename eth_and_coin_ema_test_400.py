"""
Do Filters Test - 400 coins, 1h (live system jaisa):
...
Result 'result_400.txt' mein save hota hai.
"""
...
def main():
    lines = []
    lines.append("=== ETH Regime + Same-Coin 4h EMA Filter Test - 400 coins ===\n")
    ...
    result_text = "\n".join(lines)
    print(result_text)
    with open("result_400.txt", "w") as f:
        f.write(result_text)
