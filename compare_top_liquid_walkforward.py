"""
Top Liquid Coins — Long-Term Walk-Forward Test (Self-Contained)
======================================================================
Sirf TOP LIQUID coins (24h volume ke hisab se pehle N_TOP_LIQUID) par,
live settings (Chandelier Multiplier 4.5, ETH Regime Filter) ke sath,
270 din (~9 mahine) ka data, 3 barabar periods mein baant kar test
karta hai - taake pata chale ke "top liquid coins" wali behtari sirf
ek chhote/hal hi ke acche dor ka asar thi, ya waqai mustaqil hai.
...
OUTPUT_FILE = "top_liquid_walkforward_result.txt"
